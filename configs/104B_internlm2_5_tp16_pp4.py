...
SEQ_LEN = 8192
HIDDEN_SIZE = 10240
NUM_ATTENTION_HEAD = 80
NUM_KV_ATTENTION_HEAD = 80
MLP_RATIO = 2.675
NUM_LAYER = 82
...
SAVE_CKPT_FOLDER = "local:./ckpt_tinystory/internlm2"
MODEL_ONLY_FOLDER = "local:./ckpt_tinystory/internlm2/10"
LOAD_CKPT_FOLDER = "local:./ckpt_tinystory/internlm2/10"
CHECKPOINT_EVERY = 10
ckpt = dict(
